...
use App\BusinessLogic\InternalProcess\Components\RegisterUserCase\RegisterInput\CompaneRegisterInput;


class CompaneRegisterController extends Controller
{
    public function __invoke(Request $request)
    {
        ...
        $model = FactoryModel::make(UserType::compane);

        $registerLogic = new RegisterLogic(
            new CompaneRegisterInput($data),
